...
<body class="monthly-summary-page">
    ...
    <nav class="monthly-summary-navbar">
        <div class="monthly-summary-logo">
             <a href="dashboard.php"><img src="logo.png" alt="Buff Budgets Logo"></a>
        </div>
        <ul class="monthly-summary-nav-links">
    ...
    <header class="monthly-summary-hero-banner hero-banner">
        <div class="monthly-summary-hero-text hero-text">
            ...
            <p class="monthly-summary-subtitle subtitle">
    ...
    <main class="monthly-summary-main">
        <h2 class="monthly-summary-heading">Welcome Back, User!</h2>
    ...
    <footer class="monthly-summary-footer">
        <div class="monthly-summary-footer-container footer-container">
            <div class="monthly-summary-footer-column footer-column">
