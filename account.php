...
<body class="account-page">
    ...
    <header class="account-hero-banner hero-banner">
        <div class="account-hero-text hero-text">
            <h1>Account Settings</h1>
            <p class="account-subtitle subtitle">
    ...
    <main class="account-main">
        <h2 class="account-heading">Welcome Back, User!</h2>
    ...
    <footer class="account-footer">
        <div class="account-footer-container footer-container">
            <div class="account-footer-column footer-column">
